...
int main(int argc, char* argv[])
{
    ...
    int num_channels = 2; // 1 channels (mono), 2 (stereo)
    int samplerate = 44100; // sample rate (44100 is default on most devices)
    int frames_per_buffer = 128; // audio buffer for portaudio
    ...
    printf("[INFO] Input device %d, output device %d\n",
        in_params.device,
        out_params.device);
